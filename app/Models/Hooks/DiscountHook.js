...
DiscountHook.calculateValues = async model => {
  ...
  switch (coupon.can_use_for) {
    ...
    default:
      // Pode ser usado por cliente ou todos
      if (coupon.type == 'percent') {
...
// Decrementa quantidade de coupons disponiveis para uso
...
// Incrementa quantidade de coupons disponiveis (quando um desconto é retirado)
